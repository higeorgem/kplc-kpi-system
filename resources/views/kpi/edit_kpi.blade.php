                ...
                <form action="{{route('kpi.update', [$kpi->id])}}" method="post" id="kpi_form">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            ...
                            <select id="kpi_type" class="form-control @error('kpi_type') is-invalid @enderror"
                                ...
                                <option value="Tasked" @if (old('kpi_type', $kpi->kpi_type)=="Tasked" ) selected="selected" @endif>
                                    Tasked</option>
                                <option value="NotTasked" @if(old('kpi_type', $kpi->kpi_type)=="NotTasked" ) selected="selected" @endif>
                                    Not Tasked</option>
                            </select>
                            @error('kpi_type')
                            <span class="invalid-feedback" role="alert">
                    ...
                    <div class="form-row">
                        <div class="form-groupv col-sm-6">
                            ...
                            <select name="unit_of_mesure" id="unit_of_mesure"
                                ...
                                <option value="%" @if (old('unit_of_mesure', $kpi->unit_of_measure)=="%" )
                                    selected="selected" @endif>%
                                </option>
                                <option value="Day" @if (old('unit_of_mesure', $kpi->unit_of_measure)=="Day" )
                                    selected="selected" @endif>Day
                                </option>
                                <option value="Hrs" @if (old('unit_of_mesure', $kpi->unit_of_measure)=="Hours" )
                                    selected="selected" @endif>Hours
                                </option>
                                <option value="No" @if (old('unit_of_mesure', $kpi->unit_of_measure)=="No" )
                                    selected="selected" @endif>No
                                </option>
                                <option value="Date" @if (old('unit_of_mesure', $kpi->unit_of_measure)=="Date" )
                                    selected="selected" @endif>
                                    Date</option>
                            </select>
                    ...
                    <div class="form-group col-sm-4">
                        ...
                        <input id="validated_achievement" type="text"
                            ...
                            value="{{ old('validated_achievement', $kpi->validated_achievement) }}"
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <input id="previous_target" type="text"
                            ...
                            value="{{ old('previous_target', $kpi->previous_target) }}" autocomplete="previous_target">
