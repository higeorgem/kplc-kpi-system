                        ...
                        @forelse (\Illuminate\Support\Facades\DB::table('k_p_i_s')->get() as $key => $kpi)
                            <tr>
                                ...
                                @php
                                    $report = new App\KPI;
                                @endphp
                                <td>{{ number_format($report->rawScore($kpi->target,$kpi->validated_achievement), 1)}}</td>
                                <td>{{ number_format($report->weightedScore($kpi->target,$kpi->validated_achievement, $kpi->weight), 1)}}</td>
